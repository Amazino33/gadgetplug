...
it('reports without deleting anything unless forced', function () {
    ...
    $this->artisan('vendors:cleanup-duplicates', ['--ignore' => ['financial_accounts', 'stores']])
...
it('deletes the empty copies and keeps the one holding the data', function () {
    ...
    $this->artisan('vendors:cleanup-duplicates', ['--force' => true, '--ignore' => ['financial_accounts', 'stores']])->assertSuccessful();
...
it('can be told a table does not count as real data', function () {
    ...
    $this->artisan('vendors:cleanup-duplicates', [
        '--force'  => true,
        '--ignore' => ['message_templates', 'financial_accounts', 'stores'],
    ])->assertSuccessful();
